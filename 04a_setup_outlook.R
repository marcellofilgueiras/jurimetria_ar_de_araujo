# ETAPA 4a — Setup ÚNICO do OAuth do Outlook pessoal (rodar 1x interativamente)
#
...
#
# Depois disso, 04_autenticar.R encontra o token automaticamente.
...
cat("\nVocê já pode rodar 04_autenticar.R.\n")
